...
export const Home = () => {
    ...
    className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-500 to-purple-600  bg-clip-text text-transparent leading-right"> 
                Hi, I'm Francine Houston
                </h1>
        
<p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
I'm a full stack software engineer with a passion for creating innovative solutions and that has a background in graphic design. My experience in apparel
