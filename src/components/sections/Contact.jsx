...
<RevealOnScroll>
    ...
    <div className="px-4 w-150">
        ...
        <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">Email: francinehouston@gmail.com</h2>
...
<div className="relative">
    ...
    <button type="submit" className="w-full bg-blue-500 text-white py-3 py-6 rounded font-medium transition relative overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] ]">
        Send Message
    </button>
